% Quorum sensing, heparosan Metabolic, Anthitetic controller, silencing and biosensor model.
% Updated 2024 Alejandro Vignoni, Yadira Boada

function [dxdt] = model_hep6p(t,x,p,pert)
MurAFlux = 1;
